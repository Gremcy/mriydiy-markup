                    ...
                    function (e) {
                      i || l.trigger('resize_scroll.xdsoft_scroller', [y]),
                        ...
                        'mousedown' === e.type || 'touchstart' === e.type
                          ? (D.ownerDocument &&
                              L(D.ownerDocument.body).addClass(
                                'xdsoft_noselect'
                              ),
              ...
              _.on('xchange.xdsoft', function (e) {
                clearTimeout(t),
                  (t = setTimeout(function () {
                    ...
                    for (
                      ...
                      (y = []),
                        ...
                        I.allowDates &&
                          ...
                          -1 ===
                            I.allowDates.indexOf(
                              E.formatDate(f, I.formatDate)
                            ) &&
                          y.push('xdsoft_disabled');
                      var b =
                        31 * (12 * f.getFullYear() + f.getMonth()) +
                        f.getDate();
                      ((!1 !== h && h < f) ||
                        (!1 !== p && f < p) ||
                        (!1 !== g && f < g) ||
                    ...
                    for (
                      P.html(k), H = '', c = parseInt(I.yearStart, 10);
                  ...
                  e
                    ? ((t = u[0].clientHeight),
                      (a = P[0].offsetHeight) - t <
                        (n =
                          P.find(e).index() * I.timeHeightInTimePicker + 1) &&
                        (n = a - t),
                      u.trigger('scroll_element.xdsoft_scroller', [
                        parseInt(n, 10) / (a - t),
                      ]))
